...
> Reviewed 2026-07-16 during the quantitative-enhancements corrective pass — nothing
> in this document's scope (trailing-stop/structure management) changed in that pass.
> See `TradingHub_Quantitative_Enhancements_Final_Audit_and_Corrective_Prompt.md` and
> `ARCHITECTURE_SIMULATOR.md` § Quantitative risk / portfolio layer for what did.
