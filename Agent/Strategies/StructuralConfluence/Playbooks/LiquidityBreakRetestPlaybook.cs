...
public sealed class LiquidityBreakRetestPlaybook : IStructuralPlaybook
{
    ...
    public PlaybookEvaluation Evaluate(StructuralEvidencePacket evidence, PlaybookRuntimeState state)
    {
        ...
        var gates = new List<MandatoryGate>
        {
            ...
            Gate("AcceptedBreakFresh", StructuralPlaybookRules.IsFresh(acceptedBreak.AvailableAt, evidence.AvailableAt, evidence.Trigger.Interval, _options.MaximumBarsSinceAcceptedBreak), pool.QualityScore * 100m, "StructuralAcceptedBreakExpired"),
        ...
        StructuralGeometry geometry = _geometry.Build(evidence, direction, rawStop, $"BrokenLiquidityPool:{pool.PoolId:N}");
        ...
        return new PlaybookEvaluation
        {
            ...
            ExpiresAt = acceptedBreak.AvailableAt + StructuralPlaybookRules.Bars(evidence.Trigger.Interval, _options.MaximumBarsSinceAcceptedBreak),
